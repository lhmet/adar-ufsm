...
#Sys.setenv(TZ = 'GMT')
pcks <- c("knitr", "emo", "pander", "knitr", "knitcitations", "pander", "htmlTable") # , "htmlTable")
# pcks <- c("knitr", "emo")
...
```{r Chunk10, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
# Exemplo: vetor
v1 <- c(1,3,4:8,10)
v1
```
...
```{r Chunk1110, message=FALSE,    tidy=FALSE, echo=TRUE, eval=FALSE}
# Exemplo: vetor
v2 <- scan()
...
```{r Chunk1111, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
# Exemplo: vetor
...
```{r Chunk1112, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
# Exemplo: dataframe 
...
```{r Chunk1120, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk1121, message=FALSE,    tidy=FALSE, echo=TRUE, eval=FALSE}
...
```{r Chunk1130, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
x <- 1:3
y <- x^2
y
# ou 
...
```{r Chunk1131, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk1132, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
print("abc")
...
```{r Chunk120, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk210, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
x
...
```{r Chunk211, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk300, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
data()
...
```{r Chunk411, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk420, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE, error=TRUE}
...
```{r Chunk421, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk422, message=FALSE,    tidy=FALSE, echo=TRUE, eval=FALSE}
# editar dados
aq_new <- fix(aq)
```
...
```{r Chunk440, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk441, message=FALSE,    tidy=FALSE, echo=TRUE, eval=FALSE}
browseURL(url = link)
```
...
```{r Chunk443, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk445, message=FALSE,    tidy=FALSE, echo=FALSE, eval=TRUE}
soi.df <- read.csv(file = "data/SOI.csv",
                   header = T,
                   na.strings = "-999.9")
```

```{r chunk446, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
head(soi.df)
str(soi.df)
```
...
```{r Chunk430, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
# cálculo de memória
bytes_per_reg <- 8
nlins <- 1500000
ncols <- 120
...
```{r Chunk6111, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE, error=TRUE}
...
```{r Chunk6120, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk6121, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk6210, message=FALSE,    tidy=FALSE, echo=FALSE, eval=TRUE}
# CHUNCK OCULTO
...
```{r Chunk6211, message=FALSE,    tidy=FALSE, echo=TRUE, eval=FALSE}
...
```{r Chunk6212, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk6213, message=FALSE,    echo=FALSE, eval=TRUE}
is.vector(bin_data)
...
```{r Chunk6214, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk630, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk631, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk632, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk633, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk634, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
m <- 1
...
```{r Chunk700, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk710, message=FALSE,    echo=TRUE, eval=TRUE, warning=FALSE}
# sessionInfo()
library(XLConnect)
...
Os dados lidos são armazenados em um *dataframe*, quando especificado apenas uma planilha, ou uma lista, quando mais de uma planilha é especificada. É possível informar os intervalos de linhas e colunas de interesse usando argumentos adicionais da função `readWorksheet()`. `r names(formals(readWorksheet))`
...
```{r Chunk720, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk721, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
# nome do SGBDR
...
```{r Chunk722, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk723, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk724, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk725, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk730, message=FALSE,    tidy=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chunk820, message=TRUE,    echo=TRUE, eval=TRUE}
...
```{r Chunk821, message=TRUE,    echo=TRUE, eval=FALSE}
# seleção iterativa de um arquivo
arq_name <- file.choose()
arq_name
```

```{r Chunk822, message=TRUE,    echo=TRUE, eval=TRUE}
...
```{r Chunk830, message=TRUE,    echo=TRUE, eval=TRUE}
...
```{r Chunk850, message=TRUE,    echo=TRUE, eval=TRUE}
...
```{r Chunk851, message=TRUE,    echo=TRUE, eval=TRUE}
...
```{r Chunk852, message=TRUE,    echo=TRUE, eval=TRUE}
...
```{r Chunk853, message=TRUE,    echo=TRUE, eval=TRUE}
...
```{r Chunk854, message=TRUE,    echo=TRUE, eval=TRUE}
tempdir()
tempfile()
