...
writeLines(
  c("```{r}","install.packages('rmarkdown', dependencies = TRUE)", 
...
Para expressões dentro de uma linha as equações são escritas entr os símbolos `$ $`, por exemplo, $y=f(x)$ foi gerada com `$y=f(x)$`. 
