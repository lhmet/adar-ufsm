...
O R Markdown é uma das formas mais simples de se escrever textos para divulgação na internet que incorporam trechos de código R. Essa combinação possibilita reproduzir na íntegra o que foi feito.
  
  * documentos dinâmicos  = código + texto
  * relatório = linguagem computacional + descrição dos resultados
