...
```{r Chun221a, message=FALSE, comment="",prompt=FALSE, echo=TRUE, eval=TRUE}
...
```{r Chun222, message=FALSE, comment="",prompt=FALSE, echo=TRUE, eval=TRUE}
library(abind)
abind(atemp, atemp[, , 1])
```
...
knitr::include_graphics("figs/pepper.jpg")
```

`x[1]` é o frasco de pimenta com apenas 1 pacote de pimenta:

```{r, out.width = 200, fig.retina = NULL, echo = FALSE}
knitr::include_graphics("figs/pepper-1.jpg")
```
...
```{r, out.width = 200, fig.retina = NULL, echo = FALSE}
knitr::include_graphics("figs/pepper-2.jpg")
```

Se quiséssemos o conteúdo do pacote seria `x[[1]][[1]]`

```{r, out.width = 200, fig.retina = NULL, echo = FALSE}
knitr::include_graphics("figs/pepper-3.jpg")
```
