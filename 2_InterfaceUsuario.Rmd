...
Durante o curso será usada a linha de comando Linux. A linha de comando  é acessível pelo atalho `<ctrl + Alt + t>` ou apertando a tecla Super [^1] e digitando "terminal" no [dash](https://www.lifewire.com/complete-guide-ubuntu-unity-dash-2202066) do Ubuntu. 

[^1]: Tecla com desenho de uma janela, geralmente localizada entre as teclas *Ctrl* e *Alt*.

[Shell](linuxquestions.org/questions/linux-software-2/postscript-to-jpeg-606270/)
