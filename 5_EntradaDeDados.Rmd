...
```{r, include = FALSE}
# colocar link para site mostrando como instalar netcdf no windows
```
...
- as dimensões (162 linhas, 168 colunas, 27216 células e 408 camadas)
    ...
    - as camadas neste representam o tempo (408 meses), ou seja o conjunto de dados possui 408 campos espaciais da precipitação mensal de 1980 a 2013 (e.g., (2013-1980+1) * 12 = `r (2013-1980+1) * 12`) .
...
```{r Chunk710, message=FALSE, comment="",prompt=FALSE, tidy=FALSE, echo=TRUE, eval=TRUE}
# sessionInfo()
...
```{r Chunk855, message=TRUE, comment="",prompt=FALSE, echo=TRUE, eval=FALSE}
 require(XML) 
